...
model = dict(
    ...
    neck=dict(in_channels=[128, 320, 512], out_channels=96, num_csp_blocks=1),
    bbox_head=dict(
        in_channels=96,
        feat_channels=96,
        exp_on_reg=False,
...
work_dir = './work_dirs/rtmdet-r2/dota/only_lsknet-3x/'
test_evaluator = dict(_delete_=True, outfile_prefix=work_dir + 'only_lsknet_Task1')