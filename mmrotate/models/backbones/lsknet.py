...
from mmcv.cnn import build_norm_layer  # ✅ 仍然从 mmcv.cnn 导入
from mmengine.model.weight_init import constant_init, normal_init, trunc_normal_init  # ✅ 改为从 mmengine 导入
