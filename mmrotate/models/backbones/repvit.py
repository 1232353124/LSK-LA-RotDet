...
def repvit_m0_9(pretrained=True, num_classes=1000, distillation=False,**kwargs):
    """
    Constructs a MobileNetV3-Large model
    """
    cfgs = [
    ...
    if pretrained == True:
        state_dict = torch.load(r'/root/autodl-tmp/mmrotate-1.x/jcd/repvit_m0_9_distill_450e.pth', map_location="cpu")
